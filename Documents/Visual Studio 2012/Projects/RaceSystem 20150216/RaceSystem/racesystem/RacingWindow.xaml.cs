        ...
        private void recordLap(String tag)
        {
            ...
            var task = Task.Factory.StartNew(() =>
            {
                try
                {
                    ...
                    // Lap Time Validation
                    int newLap = racer.lapNumber + 1;
                    if ((laptTime < 15 && newLap == 0)
                         || (laptTime < 15 && newLap == 1)
                         || (laptTime < 5 && (newLap != 1 || newLap != 0)))
                    {
                        if (newLap == 0)
                        {
                            racer.lapNumber = newLap;
                    ...
                    Console.WriteLine(racer.lapNumber +"  "+laptTime);
